  ...
  return {
    ...
    privacy: {
      ...
      sections: [
        ...
        { title: '你的权利', body: '你可以查看和修改个人昵称，并可在“我的 → 设置与关于”中退出登录、清理本地缓存、提交或撤回账号注销申请。完成注销后身份信息会匿名化、会话会失效；必要的脱敏业务与审计记录可能依法保留。' },
    ...
    terms: {
      ...
      sections: [
        ...
        { title: '服务变更与终止', body: '涉及重大功能或数据处理方式变化时，我们会通过合理方式通知。用户可在“我的 → 设置与关于”提交或撤回注销申请；有其他有效成员的团队应先完成所有权交接，个人团队会在注销完成时停用归档。' },
        { title: '联系我们', body: `${operator} · ${support}` },
      ],
    },
  };
