...
App({
  ...
  async tryRestoreSession() {
    const storedToken = wx.getStorageSync('CODEPOOL_TOKEN');
    if (!storedToken) {
      this.logout(false);
      return false;
    }
    ...
    try {
      ...
      wx.setStorageSync('CODEPOOL_PROFILE', {
  ...
  getStoredProfile() {
    const stored = wx.getStorageSync('CODEPOOL_PROFILE') || {};
    ...
    wx.setStorageSync('CODEPOOL_PROFILE', profile);
    return profile;
  },
  ...
  setStoredProfile(nextProfile = {}) {
    ...
    wx.setStorageSync('CODEPOOL_PROFILE', merged);
